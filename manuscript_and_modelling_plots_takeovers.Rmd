...
pp_check(sd_yaw_manual_trunc_gaussian_maximal, type = "dens_overlay_grouped", group = "n_back", ndraws = 100)
pp_check(sd_yaw_manual_trunc_gaussian_maximal, type = "dens_overlay_grouped", group = "ttc_criticality_factor", ndraws = 100)
```
